...
const routes = [
    ...
    // === Partner SPA + Admin management pages ===
    {
        ...
        children: [
            ...
            { path: 'manage/duplicates', component: () => import('../pages/Admin/Duplicates.vue'), meta: { staff: true } },
    ...
    // === Admin panel (only Users) ===
    {
        ...
        children: [
            ...
            { path: 'duplicates', component: () => import('../pages/Admin/Duplicates.vue') },
            ...
            { path: 'contracts/client-mismatches', component: () => import('../pages/Admin/ClientMismatches.vue') },
            { path: 'code-quality', component: () => import('../pages/Admin/CodeQuality.vue') },
            { path: 'management-review', component: () => import('../pages/Admin/ManagementReview.vue') },
