...
const routes = [
    ...
    // === Partner SPA + Admin management pages ===
    {
        ...
        children: [
            ...
            { path: 'manage/transactions/manual', component: () => import('../pages/Admin/ManualTransactions.vue'), meta: { staff: true } },
    ...
    // === Admin panel (only Users) ===
    {
        ...
        children: [
            ...
            { path: 'transactions/manual', component: () => import('../pages/Admin/ManualTransactions.vue') },
