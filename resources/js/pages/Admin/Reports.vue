...
// Демография — вне спеки, запрос от 03.09.2026. Два типа: сводка отвечает на
// вопрос «какой процент и как распределён возраст», список нужен для срезов,
// которых в сводке нет (по статусу, наставнику, году регистрации).
const reportTypes = [
