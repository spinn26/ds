            ...
            <v-stepper-window class="mt-4">
              ...
              <v-stepper-window-item :value="2">
                ...
                <v-card color="amber-lighten-5" class="mb-4 pa-3" variant="flat">
                  ...
                  <div class="text-body-2 mb-2">
                    Стартовый период — время, в течение которого ваш аккаунт должен быть активирован. Для этого вам нужно сделать <strong>Личный объём не менее 500 баллов</strong> суммарно за 90 дней с даты регистрации, при этом баллы должны быть начислены именно в течение этого периода.
                  </div>
