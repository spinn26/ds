 ...
 *
 * ⚠ Приоритет именно такой, а не наоборот: у части карточек `ds_percent`
 * разошёлся со строками и выглядит артефактом импорта. У Hansard_CB, WPP_Z5 и
 * WPP_Z8 там стоит 75 при единственной строке 6,00% — и ровно «75%» написано
 * в их поле «Категория» («75% от суммы полученной комиссии от клиента»).
 * Всего таких карточек со строками И общим процентом — 138.
 *
...
class ForecastDsRate
{
    ...
    private static function build(): array
    {
        ...
        foreach ($rows as $r) {
            ...
            // Строки тарифа главнее общего процента — см. подпись в карточке.
