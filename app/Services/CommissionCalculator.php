...
class CommissionCalculator
{
    ...
    public function resyncMonth(string $ym): array
    {
        ...
        // ⚠ БУДУЩИЕ периоды не пересобираем. Снимок баланса за месяц, который
        // ещё не наступил, не имеет смысла, а протяжка остатков разносит его по
        // всем партнёрам с ненулевым сальдо. Так и случилось 27.08.2026: в
        // снимке жил фантомный «2027-05» (три soft-deleted commission с кривым
        // dateMonth от транзакции 68390, датированной 2026-06-01), и ресинк
        // размножил его с 3 строк до 689 на 4,4 млн ₽.
        if ($ym > now()->format('Y-m')) {
            return ['consultants' => 0, 'pool' => 0.0];
        }
