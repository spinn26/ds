    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json([
            'ticket' => [
                ...
                'isIncident' => (bool) ($ticket->is_incident ?? false),
                'incidentNo' => $ticket->incident_no ?? null,
                'incidentSeverity' => $ticket->incident_severity ?? null,
                'incidentLoggedAt' => $ticket->incident_logged_at ?? null,
                'incidentResolvedAt' => $ticket->incident_resolved_at ?? null,
                'createdBy' => $creator ? trim(($creator->lastName ?? '') . ' ' . ($creator->firstName ?? '')) : '—',
