...
class StoreContestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['nullable', 'integer', 'exists:pgsql_v2.contest_types,id'],
            'status' => ['nullable', 'integer', 'exists:pgsql_v2.contest_statuses,id'],
            'typeEvent' => ['nullable', 'string', 'max:64'],
            'start' => ['nullable', 'date'],
            'end' => ['nullable', 'date', 'after_or_equal:start'],
            'resultsPublicationDate' => ['nullable', 'date'],
            'numberOfWinners' => ['nullable', 'integer', 'min:0'],
            'criterion' => ['nullable', 'integer', 'exists:pgsql_v2.contest_criteria,id'],
            'product' => ['nullable', 'integer', 'exists:pgsql_v2.products,id'],
            'program' => ['nullable', 'integer', 'exists:pgsql_v2.programs,id'],
